...
class FilterManager {
    constructor(workforceManager) {
        ...
        this.sortOrder = this.workforceManager.loadData('sortOrder') || 'original';
    }
    ...
    initializeCalendarFilters() {
        ...
        if (sortOrderSelect) {
            sortOrderSelect.value = this.sortOrder || 'original';
        }
    }
    ...
    setSortOrder(sortValue) {
        ...
        this.workforceManager.saveData('sortOrder', this.sortOrder);
